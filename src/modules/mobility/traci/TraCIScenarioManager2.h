...
class TraCIScenarioManager2 : public cSimpleModule
{
	public:
...
namespace Veins {
class TraCIScenarioManagerAccess2
{
	public:
		TraCIScenarioManager2* get() {
			return FindModule<TraCIScenarioManager2*>::findGlobalModule();
		};
};
}
